...
/**
 * @typedef {import("@prismicio/client").Content.ProductGridSlice} ProductGridSlice
 * @typedef {import("@prismicio/react").SliceComponentProps<ProductGridSlice>} ProductGridProps
 * @type {import("react").FC<ProductGridProps>}
 */
const ProductGrid = ({ slice }: any) => {
  // State for products
