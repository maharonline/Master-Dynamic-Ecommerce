 ...
 */
const CompareProducts = ({ slice }: any) => {
  return (
    <section
    ...
    >
      {slice.primary.product2?.map((item, index) => (
        <div
          key={index}
          className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-center bg-[#F1F1F1]  overflow-hidden shadow-sm"
        >
          {/*====== Left Side Image ===============*/}
            ...
            {item.cta_button && (
              <div className="w-full flex justify-center items-center mt-4">
                <PrismicNextLink
                  ...
                  className="bg-[#4A4A4A] text-white px-6 py-3 flex items-center gap-2 hover:bg-black transition"
                >
