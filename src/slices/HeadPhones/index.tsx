...
/**
 * @typedef {import("@prismicio/client").Content.HeadPhonesSlice} HeadPhonesSlice
 * @typedef {import("@prismicio/react").SliceComponentProps<HeadPhonesSlice>} HeadPhonesProps
 * @type {import("react").FC<HeadPhonesProps>}
 */
const HeadPhones = ({ slice }: any) => {
  // State for products
